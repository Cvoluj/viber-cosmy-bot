...
def conversation_started_message(viber, viber_request):
    ...
    viber.send_messages(
        user_id,
        [
            TextMessage(text="Привіт 👋🏻\n\nЦе Cosmy бот, твій помічник в сфері краси ♥️\n\nДля початку роботи, поділись будь ласка своїм мобільним телефоном ⬇️", keyboard=share_phone_keyboard, min_api_version=6)
        ]
    )
